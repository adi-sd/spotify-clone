...
const MediaItem: React.FC<MediaItemProps> = ({ data, onClick }) => {
    ...
    return (
        <div
            onClick={handleClick}
            className="flex items-center gap-x-4 transition cursor-pointer bg-neutral-800 hover:bg-neutral-800/50 hover:border-neutral-300 hover:scale-105 w-full p-2 rounded-md"
        >
